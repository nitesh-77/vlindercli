...
build-agents:
    ...
    cp agents/echo-agent/echo-agent-agent.toml {{vlinder_dir}}/agents/echo-agent/
    cp agents/upper-agent/target/wasm32-unknown-unknown/release/upper_agent.wasm {{vlinder_dir}}/agents/upper-agent/
    cp agents/upper-agent/upper-agent-agent.toml {{vlinder_dir}}/agents/upper-agent/
    cp agents/pensieve/target/wasm32-wasip1/release/pensieve.wasm {{vlinder_dir}}/agents/pensieve/
    cp agents/pensieve/pensieve-agent.toml {{vlinder_dir}}/agents/pensieve/
