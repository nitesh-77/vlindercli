...
pub fn put_file(storage: &Storage, path: &str, content: &[u8]) -> Result<String, Error> {
    storage.put_file(path, content)
        .map_err(|e| Error::Storage(e.to_string()))?;
    Ok("ok".to_string())
}

pub fn get_file(storage: &Storage, path: &str) -> Result<Vec<u8>, Error> {
...
pub fn delete_file(storage: &Storage, path: &str) -> Result<String, Error> {
...
pub fn list_files(storage: &Storage, dir_path: &str) -> Result<String, Error> {
